...
```
$ dstat --provider google-batch --project my-project
...
```
$ dstat --provider google-batch --project my-project --jobs my-job-id
...
```
dstat --provider google-batch --project my-project --status '*'
```
...
```
./dstat --provider google-batch --project my-project --status '*' --age 1d
```
