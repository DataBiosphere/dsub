...
gcloud storage rsync -r "${LOCAL_INPUTS}" "${INPUTS}/"
...
# is shallow. Gcloud storage prints directories with a trailing "/:" marker
# that is stripped using sed in order to match the output format of the
# `find` utility.
